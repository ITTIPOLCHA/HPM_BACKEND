 ...
 *
 * <p>
 * {@code TimeBasedOneTimePasswordGenerator} instances are thread-safe and may
 * be shared and re-used across multiple
 * threads.
 * </p>
 *
...
public class TimeBasedOneTimePasswordGenerator extends HmacOneTimePasswordGenerator {
     ...
     * by TOTP). HMAC-SHA1 is the default
     * algorithm for TOTP.
     */
     ...
     * ({@value com.ntt.otp.otpUtil.eatthepath.otp.HmacOneTimePasswordGenerator#DEFAULT_PASSWORD_LENGTH}
     * decimal digits), and HMAC
     * algorithm
     * ({@value com.ntt.otp.otpUtil.eatthepath.otp.HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}).
     *
     * @throws NoSuchAlgorithmException if the underlying JRE doesn't support the
     *                                  {@value com.ntt.otp.otpUtil.eatthepath.otp.HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}
     *                                  algorithm, which should never
     *                                  happen except in cases of serious
     *                                  misconfiguration
     */
     ...
     *                                  misconfiguration
     */
    public TimeBasedOneTimePasswordGenerator(final long timeStep, final TimeUnit timeStepUnit)
    ...
    /**
     * Constructs a new time=based one-time password generator with the given
     * time-step and password length and a
     ...
     *                       passwords to be generated; must be between
     *                       6 and 8, inclusive
     *
     * @throws NoSuchAlgorithmException if the underlying JRE doesn't support the
     *                                  {@value com.ntt.otp.otpUtil.eatthepath.otp.HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}
     ...
     *                                  misconfiguration
     */
    public TimeBasedOneTimePasswordGenerator(final long timeStep, final TimeUnit timeStepUnit, final int passwordLength)
            throws NoSuchAlgorithmException {
    ...
    /**
     * Constructs a new time=based one-time password generator with the given
     * time-step, password length, and HMAC
     * algorithm.
     *
     * @param timeStep       the magnitude of the time-step for this generator
     * @param timeStepUnit   the units for the the given time step
     ...
     *                       use when generating passwords; TOTP allows
     *                       for
     *                       {@value com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA1},
     *                       {@value com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA256},
     *                       and
     *                       {@value com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA512}
     *
     * @throws NoSuchAlgorithmException if the underlying JRE doesn't support
     *                                  HMAC-SHA1, which should never happen
     *                                  except in cases of serious misconfiguration
     *
     * @see com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA1
     * @see com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA256
     * @see com.ntt.otp.otpUtil.eatthepath.otp.TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA512
     */
    public TimeBasedOneTimePasswordGenerator(final long timeStep, final TimeUnit timeStepUnit, final int passwordLength,
     ...
     *         to format the password for display
     *         on their own
     *
     * @throws InvalidKeyException if the given key is inappropriate for
     *                             initializing the {@link Mac} for this generator
     */
    public int generateOneTimePassword(final Key key, final LocalDateTime timestamp) throws InvalidKeyException {
        return this.generateOneTimePassword(key,
                timestamp.toInstant(ZoneOffset.UTC).toEpochMilli() / this.timeStepMillis);
    }
